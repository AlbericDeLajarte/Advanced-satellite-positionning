...
pseudoranges_4_sats = [26145267.471, 24167301.217, 23029783.450, 22758409.968];
...
dist_solution = norm(r_4_sats-r_7_sats);
disp("Difference using 4 and 7 satellite is of " + dist_solution + " meters");
